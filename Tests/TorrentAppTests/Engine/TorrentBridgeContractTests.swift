...
struct TorrentBridgeContractTests {
    ...
    func pinsBridgeConstants() {
        ...
        #expect(Int32(TTORRENT_SOURCE_POLICY_HTTPS_TRACKER_POLICY) == 3)
        #expect(Int32(TTORRENT_SOURCE_POLICY_HTTPS_WEB_SEED_POLICY) == 4)
    ...
    func pinsSwiftImportedCStructLayout() {
        ...
        #expect(MemoryLayout<TTorrentNetworkStatus>.size == 672)
        #expect(MemoryLayout<TTorrentNetworkStatus>.alignment == 8)
        #expect(MemoryLayout<TTorrentNetworkStatus>.offset(of: \.dht_routing_nodes) == 664)
        #expect(MemoryLayout<TTorrentNetworkStatus>.offset(of: \.dht_status) == 668)
        #expect(MemoryLayout<TTorrentBridgeHealth>.size == 536)
        #expect(MemoryLayout<TTorrentBridgeHealth>.alignment == 8)
        #expect(MemoryLayout<TTorrentSourcePolicy>.size == 12)
