...
readonly -a LIBTORRENT_PATCHES=(
    ...
    "$ROOT_DIR/Scripts/patches/libtorrent-2.1.1-typed-allocation.patch"
    ...
    "$ROOT_DIR/Scripts/patches/libtorrent-2.1.1-global-address-policy.patch"
    "$ROOT_DIR/Scripts/patches/libtorrent-2.1.1-private-tracker-isolation.patch"
    ...
    "$ROOT_DIR/Scripts/patches/libtorrent-2.1.1-external-metainfo-import.patch"
